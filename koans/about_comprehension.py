...
class AboutComprehension(Koan):
    def test_creating_lists_with_list_comprehensions(self):
        ...
        # https://python-reference.readthedocs.io/en/latest/docs/str/capitalize.html
        comprehension = [delicacy.capitalize() for delicacy in feast]
        # https://docs.python.org/3/library/ast.html?highlight=comprehension#comprehensions
        self.assertEqual("Lambs", comprehension[0])
        self.assertEqual("Orangutans", comprehension[2])

    # https://docs.python.org/3/library/ast.html?highlight=comprehension#ast.ListComp
    ...
    # there are 3 items in the list with a length greater than 6 <----------
    ...
    def test_creating_a_set_with_set_comprehension(self):
        ...
        self.assertEqual(
            {"a", "b", "c"}, comprehension
        )  # remember that set members are unique, so only pulls out a, b, and c
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        # https://docs.python.org/3/library/configparser.html?highlight=items#configparser.ConfigParser.items
