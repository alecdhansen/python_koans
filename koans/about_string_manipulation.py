...
class AboutStringManipulation(Koan):
    # https://www.google.com/search?q=def+interpolate&oq=def+interpolate&aqs=chrome..69i57j0i10i512l3j0i22i30l3j0i10i15i22i30l2j0i15i22i30.2961j1j7&sourceid=chrome&ie=UTF-8
    ...
    # starts at char 7 and ends (including) 10
